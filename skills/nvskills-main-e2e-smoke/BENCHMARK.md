# Skill Benchmark: nvskills-main-e2e-smoke
...
- Skill: `nvskills-main-e2e-smoke`
- Evaluation date: 2026-08-07
- Evaluator version: `1.1.2`
- Agents: Claude Code (`aws/anthropic/bedrock-claude-opus-4-8`), Codex (`openai/openai/gpt-5.5`)
- Tasks: 3 evaluation tasks (2 positive, 1 negative)
- Dataset digest: `sha256:529636be4aaf027f37dcd8694549db6231c8e7aa782afc7b3b1d17ae0275397d` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
- **LOW** SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/nvskills-main-e2e-smoke/SKILL.md`)
